class Obstacles {
  ...
  setup() {
    // start-finish line
    this.start = createSprite(300, -15, 300, 1);
    this.start.setCollider("rectangle", 0, 0, 300, 1);
    this.start.debug = true;
    this.finish = createSprite(300, 0, 300, 1);
    this.finish.setCollider("rectangle", 0, 0, 300, 1);
    ...
    this.sprite2 = createSprite(-200, 0, 200, 400);
